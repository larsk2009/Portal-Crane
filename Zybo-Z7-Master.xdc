...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { pwm_out[0] }]; #IO_L23P_T3_35 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { data_out[9] }]; #IO_L1P_T0_34 Sch=jc_p[2]              
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { data_out[10] }]; #IO_L1N_T0_34 Sch=jc_n[2]              
