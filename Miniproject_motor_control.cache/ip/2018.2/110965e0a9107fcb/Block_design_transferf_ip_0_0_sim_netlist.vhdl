...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transferf_ip_src_PID_Controller is
  ...
  signal \^gain_mul_temp_1\ : STD_LOGIC_VECTOR ( 29 downto 28 );
  ...
  signal NLW_gain_mul_temp_P_UNCONNECTED : STD_LOGIC_VECTOR ( 47 downto 30 );
  ...
  signal NLW_gain_mul_temp_1_P_UNCONNECTED : STD_LOGIC_VECTOR ( 47 downto 30 );
...
\Filter_x_reg_reg[0]_i_1__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \^gain_mul_temp_1\(29),
      DI(2) => \^gain_mul_temp_1\(29),
      DI(1 downto 0) => \^gain_mul_temp_1\(29 downto 28),
...
\Filter_x_reg_reg[12]_i_1__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => '0',
      DI(2) => \^gain_mul_temp_1\(29),
      DI(1) => \^gain_mul_temp_1\(29),
      DI(0) => \^gain_mul_temp_1\(29),
...
gain_mul_temp: unisim.vcomponents.DSP48E1
    generic map(
      ...
      ALUMODE(3 downto 0) => B"0000",
      B(17 downto 0) => B"000001000011000111",
      BCIN(17 downto 0) => B"000000000000000000",
      ...
      P(47 downto 30) => NLW_gain_mul_temp_P_UNCONNECTED(47 downto 30),
      P(29) => in0,
...
gain_mul_temp_1: unisim.vcomponents.DSP48E1
    generic map(
      ...
      P(47 downto 30) => NLW_gain_mul_temp_1_P_UNCONNECTED(47 downto 30),
      P(29 downto 28) => \^gain_mul_temp_1\(29 downto 28),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transferf_ip_src_PID_Controller1 is
  ...
  signal \^gain_mul_temp\ : STD_LOGIC_VECTOR ( 29 to 29 );
  signal gain_mul_temp_n_100 : STD_LOGIC;
  signal gain_mul_temp_n_101 : STD_LOGIC;
  signal gain_mul_temp_n_102 : STD_LOGIC;
  signal gain_mul_temp_n_103 : STD_LOGIC;
...
\Filter_x_reg_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \^gain_mul_temp\(29),
      DI(2) => \^gain_mul_temp\(29),
      DI(1) => \^gain_mul_temp\(29),
      DI(0) => \^gain_mul_temp\(29),
...
Proportional_Gain_mul_temp: unisim.vcomponents.DSP48E1
    generic map(
      ...
      ACOUT(29 downto 0) => NLW_Proportional_Gain_mul_temp_ACOUT_UNCONNECTED(29 downto 0),
      ALUMODE(3 downto 0) => B"0000",
      B(17 downto 0) => B"001111101000000000",
      BCIN(17 downto 0) => B"000000000000000000",
      BCOUT(17 downto 0) => NLW_Proportional_Gain_mul_temp_BCOUT_UNCONNECTED(17 downto 0),
      C(47 downto 0) => B"111111111111111111111111111111111111111111111111",
      CARRYCASCIN => '0',
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of IPCORE_CLK : signal is "XIL_INTERFACENAME IPCORE_CLK, ASSOCIATED_RESET IPCORE_RESETN, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN Block_design_processing_system7_0_1_FCLK_CLK0";
