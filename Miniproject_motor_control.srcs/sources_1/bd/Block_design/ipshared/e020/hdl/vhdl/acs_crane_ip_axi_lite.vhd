-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\acs_cranecontroller_firsttest\acs_crane_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: acs_crane_ip_axi_lite
-- Source Path: acs_crane_ip/acs_crane_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY acs_crane_ip_axi_lite IS
...
END acs_crane_ip_axi_lite;


ARCHITECTURE rtl OF acs_crane_ip_axi_lite IS

  -- Component Declarations
  COMPONENT acs_crane_ip_addr_decoder
  ...
  COMPONENT acs_crane_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : acs_crane_ip_addr_decoder
    USE ENTITY work.acs_crane_ip_addr_decoder(rtl);

  FOR ALL : acs_crane_ip_axi_lite_module
    USE ENTITY work.acs_crane_ip_axi_lite_module(rtl);
...
BEGIN
  u_acs_crane_ip_addr_decoder_inst : acs_crane_ip_addr_decoder
  ...
  u_acs_crane_ip_axi_lite_module_inst : acs_crane_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
