...
HD_PWD='D:/EAAES/Portal-Crane/Miniproject_motor_control.runs/Block_design_pwm_prog_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_design_pwm_prog_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_design_pwm_prog_0_0.tcl
