...
HD_PWD='D:/EAAES/Miniproject_motor_control/Miniproject_motor_control.runs/Block_design_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_design_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_design_axi_gpio_0_0.tcl
